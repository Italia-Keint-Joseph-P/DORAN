...
async function loadHistoryForSession(sessionId) {
        ...
        if (response.ok) {
            ...
            sessionData.messages.forEach(msg => {
                ...
                msgDiv.innerHTML = `
                    ...
                    <div class="message-time"><i class="fas fa-${msg.sender === 'user' ? 'user' : 'robot'} me-1"></i>${new Date(msg.timestamp).toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true })}</div>
                `;
    ...
    async function sendMessage(message) {
        ...
        userMessageDiv.innerHTML = `
            ...
            <div class="message-time"><i class="fas fa-user me-1"></i>${new Date().toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true })}</div>
        `;
        ...
        try {
            ...
            setTimeout(() => {
                ...
                botMessageDiv.innerHTML = `
                    ...
                    <div class="message-time"><i class="fas fa-robot me-1"></i>${new Date(timestamp).toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true })}</div>
                `;
            ...
            errorMessageDiv.innerHTML = `
                ...
                <div class="message-time"><i class="fas fa-robot me-1"></i>${new Date().toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true })}</div>
            `;
